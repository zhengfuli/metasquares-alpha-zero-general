...
class Board(object):
    ...
    def __init__(self, n):
        self.n = n
        self.pieces = [[0]*self.n for i in range(self.n)]
        self.squaresMap = [{'points':4,'tiles':[[[x,y],[x,y+1],[x+1,y],[x+1,y+1]]
                                                for x in range(self.n-1) for y in range(self.n-1)]},
                           {'points':4,'tiles':[[[x,y],[x+1,y+1],[x+2,y],[x+1,y-1]]
                                                for x in range(self.n-2) for y in range(1,self.n-1)]},
                           {'points':9,'tiles':[[[x,y],[x,y+2],[x+2,y],[x+2,y+2]]
                                                for x in range(self.n-2) for y in range(self.n-2)]},
                           {'points':9,'tiles':[[[x,y],[x+1,y+2],[x+3,y+1],[x+2,y-1]]
                                                for x in range(self.n-3) for y in range(1,self.n-2)]},
                           {'points':9,'tiles':[[[x,y],[x+2,y+1],[x+3,y-1],[x+1,y-2]]
                                                for x in range(self.n-3) for y in range(2,self.n-1)]},
                           {'points':9,'tiles':[[[x,y],[x+2,y+2],[x+4,y],[x+2,y-2]]
                                                for x in range(self.n-4) for y in range(2,self.n-2)]},
                           {'points':16,'tiles':[[[x,y],[x,y+3],[x+3,y+3],[x+3,y]]
                                                for x in range(self.n-3) for y in range(self.n-3)]},
                           {'points':16,'tiles':[[[x,y],[x+1,y+3],[x+4,y+2],[x+3,y-1]]
                                                for x in range(self.n-4) for y in range(1,self.n-3)]},
                           {'points':16,'tiles':[[[x,y],[x+2,y+3],[x+5,y+1],[x+3,y-2]]
                                                for x in range(self.n-5) for y in range(2,self.n-3)]},
                           {'points':25,'tiles':[[[x,y],[x+3,y+3],[x+6,y],[x+3,y-3]]
                                                for x in range(self.n-6) for y in range(3,self.n-3)]},
                           {'points':16,'tiles':[[[x,y],[x+3,y+2],[x+5,y-1],[x+2,y-3]]
                                                for x in range(self.n-5) for y in range(3,self.n-2)]},
                           {'points':16,'tiles':[[[x,y],[x+3,y+1],[x+4,y-2],[x+1,y-3]]
                                                for x in range(self.n-4) for y in range(3,self.n-1)]},
                           {'points':25,'tiles':[[[x,y],[x,y+4],[x+4,y+4],[x+4,y]]
                                                for x in range(self.n-4) for y in range(self.n-4)]},
                           {'points':25,'tiles':[[[x,y],[x+4,y+1],[x+5,y+3],[x+4,y-1]]
                                                for x in range(self.n-5) for y in range(1,self.n-4)]},
                           {'points':25,'tiles':[[[x,y],[x+2,y+4],[x+6,y+2],[x+4,y-2]]
                                                for x in range(self.n-6) for y in range(2,self.n-4)]},
                           {'points':25,'tiles':[[[x,y],[x+4,y+2],[x+6,y-2],[x+2,y-4]]
                                                for x in range(self.n-6) for y in range(4,self.n-2)]},
                           {'points':25,'tiles':[[[x,y],[x+4,y+1],[x+5,y-3],[x+1,y-4]]
                                                for x in range(self.n-5) for y in range(4,self.n-1)]},
                           {'points':36,'tiles':[[[x,y],[x,y+5],[x+5,y+5],[x+5,y]]
                                                for x in range(self.n-5) for y in range(self.n-5)]},
                           {'points':36,'tiles':[[[x,y],[x+1,y+5],[x+6,y+4],[x+5,y-1]]
                                                for x in range(self.n-6) for y in range(1,self.n-5)]},
                           {'points':36,'tiles':[[[x,y],[x+2,y+5],[x+7,y+3],[x+5,y-2]]
                                                for x in range(self.n-7) for y in range(2,self.n-5)]},
                           {'points':36,'tiles':[[[x,y],[x+3,y+4],[x+7,y+1],[x+4,y-3]]
                                                for x in range(self.n-7) for y in range(3,self.n-4)]},
                           {'points':36,'tiles':[[[x,y],[x+4,y+3],[x+7,y-1],[x+3,y-4]]
                                                for x in range(self.n-7) for y in range(4,self.n-3)]},
                           {'points':36,'tiles':[[[x,y],[x+5,y+2],[x+7,y-3],[x+2,y-5]]
                                                for x in range(self.n-7) for y in range(5,self.n-2)]},
                           {'points':36,'tiles':[[[x,y],[x+5,y+1],[x+6,y-4],[x+1,y-5]]
                                                for x in range(self.n-6) for y in range(5,self.n-1)]},
                           {'points':49,'tiles':[[[x,y],[x,y+6],[x+6,y+6],[x+6,y]]
                                                for x in range(self.n-6) for y in range(self.n-6)]},
                           {'points':49,'tiles':[[[x,y],[x+1,y+6],[x+7,y+5],[x+6,y-1]]
                                                for x in range(self.n-7) for y in range(1,self.n-6)]},
                           {'points':49,'tiles':[[[x,y],[x+6,y+1],[x+7,y-5],[x+1,y-6]]
                                                for x in range(self.n-7) for y in range(6,self.n-1)]},
                           {'points':64,'tiles':[[[x,y],[x,y+7],[x+7,y+7],[x+7,y]]
                                                for x in range(self.n-7) for y in range(self.n-7)]}]
